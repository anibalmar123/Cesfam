<%-- 
    Document   : index
    Created on : 11-jun-2017, 0:05:47
    Author     : Test
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <h3>Listado de <b>Pacientes</b></h3>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editabledatatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Rut Paciente</th>
                                    <th>Dirección</th>
                                    <!--<th>Fecha &Uacute;ltima Receta</th>-->
                                    <th>Acciones</th>
                                </tr>
                            </thead>
                            <tbody>    
	...
	//out.println("Result = "+result);
        ...
        {%>
                                ...
                                <tr>
                                    ...
                                    <td><a href="./NuevaConsulta?param1=<%=result.getPaciente().get(i).getIdPaciente().intValue()%>" class="btn btn-info"> Nueva Consulta <i class="fa fa-file-o"></i></a></td>
                                </tr>
