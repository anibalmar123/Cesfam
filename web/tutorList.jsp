<%-- 
    Document   : TutorList
    Created on : 17-jun-2017, 19:00:12
    Author     : Test
--%>
...
<html>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="tutorList.jsp">Listar Tutores</a></li>
                            </ul>
                        </li>
	...
	org.datacontract.schemas._2004._07.cesfamnegocio.ArrayOfRelPacientePacienteTutor result = port.listarPacienteTutor();
	
        for(int i = 0; i < result.getRelPacientePacienteTutor().size(); i++)
        {
    
            %>
            
                                <tr>
                                    <td><%=result.getRelPacientePacienteTutor().get(i).getNombreTutor().getValue()%></td>
                                    <td><%=result.getRelPacientePacienteTutor().get(i).getNombrePaciente().getValue()%></td>
                                    <td><%=result.getRelPacientePacienteTutor().get(i).getRutPaciente().getValue()%></td>
                                    <td><a href="editTutor.jsp" class="btn btn-info">Editar <i class="fa fa-edit"></i></a></td>
                                </tr>
