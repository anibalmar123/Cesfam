...
@XmlRootElement(name = "actualizarPaciente")
public class ActualizarPaciente {
    ...
    @XmlElementRef(name = "codigoLibreta", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "fechaNac", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
